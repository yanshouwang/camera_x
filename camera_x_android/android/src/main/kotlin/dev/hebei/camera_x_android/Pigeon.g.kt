...
interface InstanceManagerHostAPI {
  ...
  companion object {
    ...
    fun setUp(binaryMessenger: BinaryMessenger, api: InstanceManagerHostAPI?, messageChannelSuffix: String = "") {
      ...
      run {
        val channel = BasicMessageChannel<Any?>(binaryMessenger, "dev.flutter.pigeon.camera_x_android.InstanceManagerHostAPI.clear$separatedMessageChannelSuffix", codec)
        if (api != null) {
...
interface ObjectHostAPI {
  ...
  companion object {
    ...
    fun setUp(binaryMessenger: BinaryMessenger, api: ObjectHostAPI?, messageChannelSuffix: String = "") {
      val separatedMessageChannelSuffix = if (messageChannelSuffix.isNotEmpty()) ".$messageChannelSuffix" else ""
      run {
        val channel = BasicMessageChannel<Any?>(binaryMessenger, "dev.flutter.pigeon.camera_x_android.ObjectHostAPI.dispose$separatedMessageChannelSuffix", codec)
        if (api != null) {
...
{
    val separatedMessageChannelSuffix = if (messageChannelSuffix.isNotEmpty()) ".$messageChannelSuffix" else ""
    val channelName = "dev.flutter.pigeon.camera_x_android.ObjectFlutterAPI.dispose$separatedMessageChannelSuffix"
...
interface CameraControllerHostAPI {
  ...
  companion object {
    ...
    fun setUp(binaryMessenger: BinaryMessenger, api: CameraControllerHostAPI?, messageChannelSuffix: String = "") {
      val separatedMessageChannelSuffix = if (messageChannelSuffix.isNotEmpty()) ".$messageChannelSuffix" else ""
      run {
        val channel = BasicMessageChannel<Any?>(binaryMessenger, "dev.flutter.pigeon.camera_x_android.CameraControllerHostAPI.create$separatedMessageChannelSuffix", codec)
        if (api != null) {
          channel.setMessageHandler { message, reply ->
            val args = message as List<Any?>
            val identifierArg = args[0].let { num -> if (num is Int) num.toLong() else num as Long }
      ...
      run {
        val channel = BasicMessageChannel<Any?>(binaryMessenger, "dev.flutter.pigeon.camera_x_android.CameraControllerHostAPI.requestPermissions$separatedMessageChannelSuffix", codec)
        if (api != null) {
          channel.setMessageHandler { _, reply ->
      ...
      run {
        val channel = BasicMessageChannel<Any?>(binaryMessenger, "dev.flutter.pigeon.camera_x_android.CameraControllerHostAPI.bindToLifecycle$separatedMessageChannelSuffix", codec)
        if (api != null) {
          channel.setMessageHandler { message, reply ->
            val args = message as List<Any?>
            val identifierArg = args[0].let { num -> if (num is Int) num.toLong() else num as Long }
      ...
      run {
        val channel = BasicMessageChannel<Any?>(binaryMessenger, "dev.flutter.pigeon.camera_x_android.CameraControllerHostAPI.unbind$separatedMessageChannelSuffix", codec)
        if (api != null) {
          channel.setMessageHandler { message, reply ->
            val args = message as List<Any?>
            val identifierArg = args[0].let { num -> if (num is Int) num.toLong() else num as Long }
      ...
      run {
        val channel = BasicMessageChannel<Any?>(binaryMessenger, "dev.flutter.pigeon.camera_x_android.CameraControllerHostAPI.setCameraSelector$separatedMessageChannelSuffix", codec)
        if (api != null) {
          channel.setMessageHandler { message, reply ->
            val args = message as List<Any?>
            val identifierArg = args[0].let { num -> if (num is Int) num.toLong() else num as Long }
...
interface PreviewViewHostAPI {
  ...
  companion object {
    ...
    fun setUp(binaryMessenger: BinaryMessenger, api: PreviewViewHostAPI?, messageChannelSuffix: String = "") {
      val separatedMessageChannelSuffix = if (messageChannelSuffix.isNotEmpty()) ".$messageChannelSuffix" else ""
      run {
        val channel = BasicMessageChannel<Any?>(binaryMessenger, "dev.flutter.pigeon.camera_x_android.PreviewViewHostAPI.create$separatedMessageChannelSuffix", codec)
        if (api != null) {
          channel.setMessageHandler { message, reply ->
            val args = message as List<Any?>
            val identifierArg = args[0].let { num -> if (num is Int) num.toLong() else num as Long }
      ...
      run {
        val channel = BasicMessageChannel<Any?>(binaryMessenger, "dev.flutter.pigeon.camera_x_android.PreviewViewHostAPI.setController$separatedMessageChannelSuffix", codec)
        if (api != null) {
          channel.setMessageHandler { message, reply ->
            val args = message as List<Any?>
            val identifierArg = args[0].let { num -> if (num is Int) num.toLong() else num as Long }
      ...
      run {
        val channel = BasicMessageChannel<Any?>(binaryMessenger, "dev.flutter.pigeon.camera_x_android.PreviewViewHostAPI.setScaleType$separatedMessageChannelSuffix", codec)
        if (api != null) {
          channel.setMessageHandler { message, reply ->
            val args = message as List<Any?>
            val identifierArg = args[0].let { num -> if (num is Int) num.toLong() else num as Long }
